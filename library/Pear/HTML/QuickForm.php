...
$GLOBALS['_HTML_QuickForm_registered_rules'] = array(
	...
	'comparetrim'   => array('html_quickform_rule_compare_trim'	, 'HTML/QuickForm/Rule/CompareTrim.php'),
	'cpf'           => array('html_quickform_rule_cpf'			, 'HTML/QuickForm/Rule/Cpf.php'),
	'cep'           => array('html_quickform_rule_cep'			, 'HTML/QuickForm/Rule/Cep.php'),
	'date'          => array('html_quickform_rule_date'			, 'HTML/QuickForm/Rule/Date.php'),
	'fone'          => array('html_quickform_rule_fone'			, 'HTML/QuickForm/Rule/Fone.php'),
	'card'          => array('html_quickform_rule_card'			, 'HTML/QuickForm/Rule/Card.php')
);
...
class HTML_QuickForm extends HTML_Common
{
     ...
     * @var  array
     */
    protected $_duplicateIndex = array();
    ...
    //public $_jsPostfix = 'Por favor corrija.';
    public $_jsPostfix = '';
     ...
     * @var       boolean
     */
    protected $_flagSubmitted = false;
     ...
     * @return    void
     */
    static public function registerRule($ruleName, $type, $data1, $data2 = null)
    {
    ...
    */
    ...
    public function updateElementAttr($elements, $attrs)
    {
        ...
        foreach (array_keys($elements) as $key) {
            if (is_object($elements[$key]) && $elements[$key] instanceof HTML_QuickForm_element) {
    ...
    */
    ...
    public function isRuleRegistered($name, $autoRegister = false)
    {
        ...
        include_once 'HTML/QuickForm/RuleRegistry.php';
        $ruleName = false;
        if (is_object($name) && $name instanceof html_quickform_rule) {
    ...
    */
    ...
    {
        return (is_object($value) && $value instanceof html_quickform_error);
    } // end func isError
