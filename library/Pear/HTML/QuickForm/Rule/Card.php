 ...
 * @since       3.2
 */
class HTML_QuickForm_Rule_Card extends HTML_QuickForm_Rule
{
	...
	{
		return preg_match(Util_Format_CreditCard::Regex . 'D', $card) ? true : false;
	}
    ...
    {
        return array("  var regex = " . Util_Format_CreditCard::Regex . ";\n", "{jsVar} != '' && !regex.test({jsVar})");
    }
