 ...
 * @version $Id: ExceptionTest.php 10/12/2011 14:01:12 leonardo $
 */
 ...
 * @copyright Copyright (c) Os Autores
 */
class Util_Model_ExceptionTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Util_Model_Exception
     */
    protected $object;
    ...
    {
        $this->object = new Util_Model_Exception;
    }
