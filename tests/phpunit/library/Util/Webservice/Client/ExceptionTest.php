 ...
 * @version $Id: ExceptionTest.php 12/12/2011 08:41:43 leonardo $
 */
 ...
 * @copyright Copyright (c) Os Autores
 */
class Util_Webservice_Client_ExceptionTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Util_Webservice_Client_Exception
     */
    protected $object;
    ...
    {
        $this->object = new Util_Webservice_Client_Exception;
    }
    ...
    {
    	$this->assertType('Util_Webservice_Exception', $this->object);
